...
console.log('\n11  stamps and missing libraries');
{
  ...
  is(/<img> is allowed for a user-provided Image URL, for a supplied photograph, for a supplied brand mark, and for any supplied design asset, and for nothing else\./.test(P.HTML_PROMPT),
